...
CREATE TABLE `t_comment` (
  ...
  `mid` int(11) DEFAULT NULL COMMENT '阅圈拥有者id',
  ...
  KEY `FK_Reference_9` (`mid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='评论数据';
...
CREATE TABLE `t_thumbs_up` (
  `thumbs_up_id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `comment_id` int(11) DEFAULT NULL,
  `nickname` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`thumbs_up_id`),
  KEY `FK_Reference_7` (`uid`),
  KEY `FK_Reference_8` (`comment_id`)
...
CREATE TABLE `t_user` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户基本数据';
